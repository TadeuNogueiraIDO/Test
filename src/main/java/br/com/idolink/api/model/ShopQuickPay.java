...
@Setter
@Entity
@Table(name = "shop_quick_pay")
@AllArgsConstructor
@RequiredArgsConstructor
@Where(clause = "dt_deleted is null")
@SQLDelete(sql = "UPDATE shop_quick_pay SET dt_deleted = CURRENT_TIMESTAMP WHERE id=? and version=?")
@Builder
public class ShopQuickPay extends BaseModel<ShopQuickPay>{
	...
	@OneToMany(cascade = CascadeType.ALL, mappedBy = "shopQuickPay", orphanRemoval = true)
	private List<ShopQuickPayProduct> products;
