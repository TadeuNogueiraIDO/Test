...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEntidadeNaoEncontrada(AccessDeniedException ex, WebRequest request) {
		...
		Problem.Object problemObj = new Problem.Object(problemType.getTitle(), detail);
		problemObjects.add(problemObj);
	...
	@ExceptionHandler(BaseFullException.class)
	public ResponseEntity<Object> handleConflitBusiness(BaseFullException ex, WebRequest request) {
		...
		errors.add(new ObjectError(ex.getField(), messageSource.getMessage(ex.getMessage(), ex.getParams(), Locale.forLanguageTag(languagem))));
	    ...
	    Problem problem = createProblemBuilder(ex.getStatus(), problemType, detail)
	        .userMessage(detail)
	        .objectList(problemObjects)
	        .build();
	...
	public ResponseEntity<Object> handleNegocio(BaseException ex, WebRequest request) {

		HttpStatus status = ex.getStatus();
		String detail = ex.getMessage();
		 
		List<Problem.Object> problemObjects = new ArrayList<>();
		Problem.Object problemObj = new Problem.Object(status.getReasonPhrase(), detail);
		problemObjects.add(problemObj);
